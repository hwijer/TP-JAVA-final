...
public class EmployeeDAOImpl implements EmployeeDAOI , GeneriqueDAOI<Employee> , DataImportExport<Employee>{
    ...
    public void importData(String filePath) {
        ...
        try(BufferedReader reader =new BufferedReader(new FileReader(filePath)) ; PreparedStatement pstmt = connection.prepareStatement(query)){
            ...
            while((Line = reader.readLine()) != null){
                ...
                System.out.println("data imported "+data.length);
            }
            pstmt.executeBatch();
    ...
    public void exportData(String fileName, List<Employee> data) throws IOException {
     try(BufferedWriter writer =new BufferedWriter(new FileWriter(fileName))){
         writer.write("nom, prenom, salaire, email, phone, role, poste");
         writer.newLine();
